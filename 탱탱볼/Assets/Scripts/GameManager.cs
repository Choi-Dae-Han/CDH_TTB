...
public class GameManager : MonoBehaviour
{
    ...
    public void RetryStage()
    {
        ...
        GameObject obj = CreateUI(TimeUI, new Vector3(0f, 260f, 0f));
        TimeText = obj.GetComponent<Text>();

        CreateUI(PauseButton, new Vector3(520f, 260f, 0f));
        ClearChild(MainCameraTr);
        nAddScoreObj = 0;
    ...
    public void StageClear(ClearObj clearObj)
    {
        ...
        Stage s = PlayingStage.GetComponent<Stage>();
        s.Opened = true;
        s.Cleared = true;
        nScore = 0;
        int tempScore = 1;
